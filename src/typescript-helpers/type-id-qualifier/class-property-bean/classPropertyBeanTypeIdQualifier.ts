import { IClassPropertyDeclaration, ITypeIdQualifierResult } from '../common/types';
...
export function classPropertyBeanTypeIdQualifier(property: IClassPropertyDeclaration): ITypeIdQualifierResult {
