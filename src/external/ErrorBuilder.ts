...
export class ErrorBuilder {
    ...
    static usageWithoutConfiguredDI(cause: string = 'DI'): Error {
        return new Error(`You are trying to use ${cause} without without proper dependency-injection-cat configuration or in wrong place, please check the documentation ${GITHUB_REPO_LINK}`);
    }
