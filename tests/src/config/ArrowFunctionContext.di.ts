...
class ArrowFunctionContext extends CatContext<IBeans> {
    @Bean testClass0Dependencies = (): ITestClass0Dependencies => new TestClass0Dependencies()

    @Bean testClass1Dependency = (
        testClass0Dependencies: ITestClass0Dependencies
    ): ITestClass1Dependency => new TestClass1Dependency(testClass0Dependencies)
}
